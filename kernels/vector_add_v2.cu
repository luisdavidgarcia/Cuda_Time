/* This program compares against three methods:
 * 1. The host matrix addition
 * 2. The device matrix addition in 1D
 * 3. The device matrix addition in 3D
 * Results: The device matrix addition is 1D is optimal since it requires less
 * operations to complete than the 3D
 */
...
int main(void) {
    ...
    // Benchmark GPU 1D implmentation
    ...
    printf("1D Results are are %s\n", correct_1d ? "correct" : "incorrect");

    // Benchmark GPU 3D implmentation
